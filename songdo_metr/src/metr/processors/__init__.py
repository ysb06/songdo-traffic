...
RAW_METR_SHAPEFILE_FILENAME = "metr_imc.shp"
...
RAW_DISTANCES_SHAPEFILE_FILENAME = "distances_imc.shp"
...
RAW_METR_IMC_SHAPEFILE_PATH = os.path.join(RAW_MISCELLANEOUS_DIR_PATH, RAW_METR_SHAPEFILE_FILENAME)
...
RAW_DISTANCES_SHAPEFILE_PATH = os.path.join(RAW_MISCELLANEOUS_DIR_PATH, RAW_DISTANCES_SHAPEFILE_FILENAME)
