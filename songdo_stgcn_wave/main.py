...
parser.add_argument(
    "--sensorsfilepath",
    type=str,
    default="./datasets/METRLA/metr_ids.txt",
    help="sensors file path",
)
parser.add_argument(
    "--disfilepath",
    type=str,
    default="./datasets/METRLA/distances_la_2012.csv",
    help="distance file path",
)
parser.add_argument(
    "--tsfilepath", type=str, default="./datasets/METRLA/metr-la.h5", help="ts file path"
)
parser.add_argument(
    "--savemodelpath",
    type=str,
